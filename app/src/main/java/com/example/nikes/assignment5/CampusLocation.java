...
public class CampusLocation extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //if(name == "Progress Campus") {
            ...
            mMap.addMarker(new MarkerOptions().position(progress).title("Marker in Centennial-Progress Campus"));
